...
export default function Dashboard() {
  ...
  async function handleAddFriend(e) {
    ...
    if (!error) {
      setSuccess(true);
      setForm({ name: "", birthday: "", city: "", phone: "", fun_fact: "", favorite_drink: "" });
      fetchFriends();
      ...
      <div style={{ flex: 1, padding: "1.5rem", overflowY: "auto" }}>
        ...
        {tab === "Band" && (
          <div>
            ...
            {loading && (
              <p style={{ color: "rgba(200,160,80,0.3)", fontSize: "0.85rem" }}>Loading your band...</p>
            )}
            {!loading && sorted.length === 0 && (
              <div style={{ textAlign: "center", paddingTop: "3rem" }}>
                <p style={{ color: "rgba(200,160,80,0.3)", fontSize: "0.9rem", lineHeight: 1.8 }}>
                  ...
                  <span
                    onClick={() => setTab("Add")}
                    style={{ color: "#e8c87a", cursor: "pointer", textDecoration: "underline" }}
                  >
        ...
        {tab === "Add" && (
          <div style={{ maxWidth: 420 }}>
            <p style={{ fontSize: "0.75rem", color: "rgba(200,160,80,0.4)", letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: "1.5rem" }}>
              Add to your band
            </p>
            ...
            {success ? (
              <div style={{ textAlign: "center", paddingTop: "2rem" }}>
                ...
                <p style={{ color: "#e8c87a", fontSize: "1rem" }}>Added to your band!</p>
              </div>
            ) : (
              <form onSubmit={handleAddFriend} style={{ display: "flex", flexDirection: "column", gap: "1.2rem" }}>
                <div>
                ...
                <div>
                  ...
                  <input
                    style={inputStyle}
                    placeholder="Can juggle 4 balls"
                    value={form.fun_fact}
